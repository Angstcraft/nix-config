...
in {
  ...
  # Permissions
  c.content.notifications.enabled = True  # Renamed option
  c.content.geolocation = "ask"
  c.content.cookies.store = True  # Correct option for cookies storage
  c.content.javascript.enabled = True

  # Enable uBlock Origin (Update path to the actual stylesheet)
  c.content.user_stylesheets = ["file:///home/alpha/.config/qutebrowser/ublock-origin.css"]  # Correct path
