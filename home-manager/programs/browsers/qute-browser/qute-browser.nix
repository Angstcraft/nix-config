        ...
        "folders": [
          {
            ...
            "links": [
              ...
              {"title": "Github", "url": "https://github.com/Angstcraft", "icon": ""},
              {"title": "Marxist", "url": "https://www.marxists.org", "icon": ""},
              {"title": "Technik", "url": "https://technik.reicke.de/", "icon": ""},
              {"title": "50Ohm", "url": "https://50ohm.de/", "icon": "󰭹"},
              {"title": "IServ", "url": "https://osztiem-edu.de/", "icon": ""},
              {"title": "Hyprland Wiki", "url": "https://wiki.hyprland.org/", "icon": "󰖬"},
              {"title": "Youtube", "url": "https://youtube.com", "icon": "󰗃"},
              {"title": "Mythoskop", "url": "https://mythoskop.de/#/", "icon": ""},
